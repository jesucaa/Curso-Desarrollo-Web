...
// Si solo tiene una linea en la operacion de la funcion como la de arriba, podemos quitar las llaves de la sig. manera
const sumar2 = (n1, n2) => console.log(n1 + n2);
sumar2(10, 10);

// Cuando tu función solo tiene un parametro, puedes quitar los parentesis
...
let existe = carrito.some(producto => producto.nombre === 'Celular');
if (existe) {
...
resultado = carrito.reduce((total, producto) => total + producto.precio, 0); // El segundo parámetro es el valor inicial del total
